...
void main() {
  group('StellarAddress.parse', () {
    ...
    test('identifies kind as g for valid standard address', () {
      ...
      expect(result.baseG, equals(validAddress));
      expect(result.muxedId, isNull);
    });
    ...
    test('identifies kind as m for valid muxed address', () {
      ...
      expect(result.baseG, isNotNull);
      expect(result.muxedId, isNotNull);
    });

    test('identifies kind as c for valid contract address', () {
